...
export default function Page(){
  ...
  async function bonus(u){ const {error}=await supabase.rpc("owner_add_comment_bonus",{p_user_id:u.id,p_amount:1}); if(error)setNotice(error.message); else loadProfiles(); }
